...
struct dogma_location_s {
	...
	union {
		dogma_key_t implant_index; /* The index generated by dogma_add_implant(). */
		dogma_key_t module_index; /* The index generated by dogma_add_module(). */
		dogma_key_t area_beacon_index; /* The index generated by dogma_add_area_beacon(). */
...
/* Get an attribute of an area beacon. Use the index generated by
 * dogma_add_area_beacon(). */
